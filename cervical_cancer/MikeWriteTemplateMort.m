...
for icol=5:10
    ...
    elseif icol==10
        for irow=7:107
            A{irow,(icol+sA)}=StageIV(1,irow-6);
        end
    end
end
...
for icol=11:15
        for irow=8:108
            B{irow,icol+sBG}=RMortalityTx(icol-10,irow-7);
            G{irow,icol+sBG}=Mu_NoTx(icol-10,irow-7);
        end
end
...
for icol=5:9
    ...
    elseif icol==9
        for irow=8:108
            C{irow,icol+sC}=RRStageIV(1,irow-7);
        end
    end
end
